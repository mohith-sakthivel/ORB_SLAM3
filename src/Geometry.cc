...
void Geometry::GeometricModelCorrection(const ORB_SLAM3::Frame &currentFrame,
...
void Geometry::InpaintFrames(const ORB_SLAM3::Frame &currentFrame,
...
vector<Geometry::DynKeyPoint> Geometry::ExtractDynPoints(const vector<ORB_SLAM3::Frame> &vRefFrames,
...
void Geometry::CombineMasks(const ORB_SLAM3::Frame &currentFrame, cv::Mat &mask)
{
...
void Geometry::FillRGBD(const ORB_SLAM3::Frame &currentFrame,cv::Mat &mask,cv::Mat &imGray,cv::Mat &imDepth){
    ...
    for (int i(0); i < mDB.mNumElem; i++){
        ...
        ORB_SLAM3::Frame refFrame = mDB.mvDataBase[i];
...
void Geometry::FillRGBD(const ORB_SLAM3::Frame &currentFrame,cv::Mat &mask,cv::Mat &imGray,cv::Mat &imDepth,cv::Mat &imRGB){
...
bool Geometry::IsInFrame(const float &x, const float &y, const ORB_SLAM3::Frame &Frame)
{
    mDmax = 20;
