...
private:
    ...
    vector<DynKeyPoint> ExtractDynPoints(const vector<ORB_SLAM3::Frame> &vRefFrames, const ORB_SLAM3::Frame &currentFrame);
    ...
    void FillRGBD(const ORB_SLAM3::Frame &currentFrame,cv::Mat &mask,cv::Mat &imGray,cv::Mat &imDepth);
    void FillRGBD(const ORB_SLAM3::Frame &currentFrame,cv::Mat &mask,cv::Mat &imGray,cv::Mat &imDepth,cv::Mat &imRGB);
    ...
    bool IsInFrame(const float &x, const float &y, const ORB_SLAM3::Frame &Frame);
...
public:
    Geometry();
    ~Geometry() = default;
    void GeometricModelCorrection(const ORB_SLAM3::Frame &currentFrame, cv::Mat &imDepth, cv::Mat &mask);
    void InpaintFrames(const ORB_SLAM3::Frame &currentFrame, cv::Mat &imGray, cv::Mat &imDepth, cv::Mat &imRGB, cv::Mat &mask);
